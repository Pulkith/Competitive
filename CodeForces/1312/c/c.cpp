...
//check if each number in an array can be formed by the sum of
// some powers of K. Each power of K can only be used once in
// the array

//Alternate Solution: 
//Since each power of 𝑘 is used atmost once, if at all, we 
//simply convert each number to base 𝑘, and see if any 
//power of 𝑘 is repeated.
