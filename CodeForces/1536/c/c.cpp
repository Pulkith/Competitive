...
#define dbg(...) GET_MACRO(__VA_ARGS__, dbg5, dbg4, dbg3, dbg2, dbg1) \
(__VA_ARGS__)
...
Split string into maximum # of chunks such that each chunk has an equal ratio of D and Ks
calculate this for each prefix of the string
